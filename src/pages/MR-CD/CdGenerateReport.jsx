...
const CdGenerateReport = () => {
  ...
  const user = { name: "Pema Tshoki", role: "CD Officer" };
    ...
    <div className="space-y-6">
      ...
      >
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-4 pt-4">
            <button onClick={() => navigate("/cd/reports")} className="px-8 py-3 font-bold text-gray-500 hover:bg-gray-100 rounded-xl transition-all">
              Cancel
            </button>
            <button
...
export default CdGenerateReport;
    ...
    <div className="space-y-8 pb-10">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <InfoCard icon={FileText} label="Dzongkhag" value={project.dzongkhag} />
          <InfoCard icon={FileText} label="Duration" value="1 year" />
          <InfoCard icon={Calendar} label="End Date" value="Dec 31, 2025" />
          <InfoCard icon={Globe} label="Donor" value="UNDP" />
          <InfoCard icon={Users} label="Total Beneficiaries" value="30" />
        </div>
      </div>

...
const GenerateReport = () => {
  ...
  const backPath = isPO ? '/po/reports' : '/reports';
  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-end gap-4 pt-4">
          ...
          <button 
            ...
            className="flex items-center gap-2 px-8 py-2.5 bg-[#3498db] text-white rounded-xl hover:bg-blue-600 transition-all shadow-lg shadow-blue-200 font-bold"
          >
            <Sparkles size={18} />
      ...
      <SuccessModal 
        ...
        description="Your report has been generated successfully and is ready to view or download."
        icon={TrendingUp}
